...
namespace gradingform_benchmarks\grades\grader\gradingpanel\external;
...
class fetch_test extends advanced_testcase {
    ...
    public function test_execute_fetch_empty(): void {
        ...
        $this->assertEquals('gradingform_benchmarks/grades/grader/gradingpanel', $result['templatename']);
