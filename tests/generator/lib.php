...
use tests\gradingform_benchmarks\generator\checklist;
use tests\gradingform_benchmarks\generator\criterion;
...
class gradingform_benchmarks_generator extends component_generator_base {
     ...
     * @return gradingform_benchmarks_controller
     */
    public function create_instance(
        ...
        string $description,
        array $criteria
    ): gradingform_benchmarks_controller {
        global $USER;
    ...
    /**
     * Get a new checklist for use with a gradingform_benchmarks_generator_checklist.
     *
     * Note: This is just a helper class used to build a new definition. It does not persist the data.
     *
     * @param string $description
     * @param array $items Set of items in the form definition => score
     * @return gradingform_benchmarks_generator_criterion
     */
     ...
     */
    public function get_submitted_form_data(gradingform_benchmarks_controller $controller, int $itemid, array $values): array {
        $result = [
            'itemid' => $itemid,
            'groups' => [],
        ];
     ...
     * @return gradingform_benchmarks_controller
     */
    public function get_test_checklist(context $context, string $component, string $area): gradingform_benchmarks_controller {
        $criteria = [
            'Group 1' => [
                'Has title' => 1
            ],
    ...
    public function get_test_form_data(
        gradingform_benchmarks_controller $controller,
        int $itemid,
        ...
        $generator = \testing_util::get_data_generator();
        $checklistgenerator = $generator->get_plugin_generator('gradingform_benchmarks');
